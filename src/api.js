...
//export const base_url = 'https://api-twitterclone-nextjs2.herokuapp.com/';
...
export const addTweet = async ({currentUserId, tweetContent, images}) => {
